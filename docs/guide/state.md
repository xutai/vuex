...
### [](/guide/state.html#single-state-tree)Single State Tree
...
### [](/guide/state.html#getting-vuex-state-into-vue-components)Getting Vuex State into Vue Components
...
### [](/guide/state.html#the-mapstate-helper)The `mapState` Helper
...
### [](/guide/state.html#object-spread-operator)Object Spread Operator
...
### [](/guide/state.html#components-can-still-have-local-state)Components Can Still Have Local State
