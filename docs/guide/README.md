...
### [](/guide/#the-simplest-store)The Simplest Store
...
After [installing](/installation.html) Vuex, let's create a store. It is pretty straightforward - just provide an initial state object, and some mutations:
...
Next, we will discuss each core concept in much finer details, starting with [State](/guide/state.html).